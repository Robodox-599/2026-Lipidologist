...
//                 DCMotor.getKrakenX60Foc(1), HoodConstants.hoodMOI, HoodConstants.hoodGearRatio),
//             DCMotor.getKrakenX60Foc(1));

//     pid =
//         new ProfiledPIDController(
//             HoodConstants.hoodSimkP,
//             HoodConstants.hoodSimkI,
//             HoodConstants.hoodSimkD,
//             new Constraints(HoodConstants.hoodMaxVelocity, HoodConstants.hoodMaxAcceleration));
//   }
...
//     hoodMotorSim.setInputVoltage(
//         pid.calculate(hoodMotorSim.getAngularPositionRotations(), position));
//   }
