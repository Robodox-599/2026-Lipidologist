...
public class Motor {
    ...
    public record MotorConstants(
        ...
        double kP, double kI, double kD, double kS, double kV, double kG,
        ...
        public MotorConstants(
            String name, int motorID, String canBus, InvertedValue invert,
            NeutralModeValue neutralMode, double gearRatio, double statorCurrentLimitAmps,
            double supplyCurrentLimitAmps, Double forwardSoftLimitRotations, Double reverseSoftLimitRotations,
            double openLoopRampRateSec, double closedLoopRampRateSec,
            double kP, double kI, double kD, double kS, double kV, double kG
        ) {
            this(name, motorID, canBus, invert, neutralMode, gearRatio, statorCurrentLimitAmps,
                 supplyCurrentLimitAmps, forwardSoftLimitRotations, reverseSoftLimitRotations,
                 openLoopRampRateSec, closedLoopRampRateSec, kP, kI, kD, kS, kV, kG,
